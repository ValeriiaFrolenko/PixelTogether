 ...
 * 01      1       bSrc      Unique client application identifier
 ...
 * 04      4         sessionId  Session identifier (guest or authenticated user), big-endian
 * 08      4         roomId     Room identifier, 0 if not applicable, big-endian
 * 12      wLen-12   payload    JSON-encoded data as byte array, big-endian
 */
public final class MessageStructure {
    ...
    public static final int LEN_SESSION_ID = 4;
    public static final int LEN_ROOM_ID    = 4;

    public static final int OFFSET_CMD_TYPE   = 0;
    public static final int OFFSET_SESSION_ID = OFFSET_CMD_TYPE + LEN_CMD_TYPE;
    public static final int OFFSET_ROOM_ID    = OFFSET_SESSION_ID + LEN_SESSION_ID;
